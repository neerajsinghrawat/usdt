...
public function referrer()
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'address', 'city', 'postal_code', 'phone', 'country', 'provider_id', 'email_verified_at', 'verification_code' ,'parent_id' , 'status', 'referral_code', 'referred_by','id_document','document_image','package_no','package_amount','pending_usdt','avatar','withdrawal_code','roi_month'
    ];
    ...
    protected static function boot()
{
    ...
    static::creating(function ($user) {
        $user->referral_code = 'REF' . strtoupper(bin2hex(random_bytes(4)));
    });
}
